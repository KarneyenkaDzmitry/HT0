...
public class Microwave extends Furniture {

    /*The parameter is used for making default name: "No name microwave №" + count.*/
    ...
    public Microwave(String name, int minSpace, int maxSpace) {
     ...
     *  Call the suitable constructor of parent Furniture.*/
    public Microwave(String name, int maxSpace) {
        super(name, maxSpace);
    }
     ...
     *  @param name - "No name microwave №" + count (@see count);
     *  @param maxSpace (int)- maxSpace that the furniture can take up.
     *  And increment private static int count (@see count).*/
    public Microwave(int maxSpace) {
        super("No name microwave №" + count, maxSpace);
        count++;
    }
     ...
     *  @param maxSpace (int)- maxSpace that the furniture can take up.
     *  And increment private static int count (@see count).*/
    public Microwave(int minSpace, int maxSpace) {
        super("No name microwave №" + count, minSpace, maxSpace);
        count++;
    }
}
